...
c41   continue
c     Buffering and projecting refinement flags reads neighbouring patch
c     metadata and shared AMR work arrays.  Preserve deterministic grid order
c     during regridding; the conservation-law advance remains parallel.
