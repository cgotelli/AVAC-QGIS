...
!                endif
 ...
 603        format('+++ ij: ',8i7)
        ...
        ! Once this part of the observation grid has been initialized, an
        ! exactly dry computational patch cannot increase depth, speed, or
        ! arrival maxima.  Skipping its interpolation is especially important
        ! when dt_check=0 requests an exact update at every solver step.  Do
