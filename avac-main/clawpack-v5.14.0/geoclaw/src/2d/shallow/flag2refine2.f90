...
subroutine flag2refine2(mx,my,mbc,mbuff,meqn,maux,xlower,ylower,dx,dy,t,level, &
    ...
    real(kind=8) :: energy_speed, numerical_energy_speed
        ...
        x_loop: do i = 1,mx
            ...
            if (q(1,i,j) > dry_tolerance) then
                ...
                if(adjoint_flagging) then
                    ...
                    ! A speed by itself is ill-conditioned at a granular
                    ! wet/dry front: roundoff-scale depths can have finite or
                    ! even large q/h and repeatedly create fine patches after
                    ! the resolved deposit has arrested.  In AVAC mode, also
