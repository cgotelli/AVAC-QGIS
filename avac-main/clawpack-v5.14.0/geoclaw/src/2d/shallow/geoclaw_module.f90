...
module geoclaw_module
    ...
    ! GeoClaw's default AMR transfer preserves a constant free surface over
    ! bathymetry, which is appropriate for water at rest but is not a
    ! conservative transfer for AVAC's flow-depth variable at a wet/dry
    ! granular front.  AVAC's setprob enables this switch; ordinary GeoClaw
