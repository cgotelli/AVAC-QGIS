...
def run() -> None:
    ...
    # The canonical 2999 by 1999 QGIS DEM has physical 1 m cells. Exercise the
    # normal minimum edge crop that makes both dimensions fit 2 m solver cells.
    dock._set_controlled_parameters({
        "release.d0": 1.6, "release.correction_elevation": True, "release.correction_slope": True,
        "computation.cell_size": 2.0,
    })
